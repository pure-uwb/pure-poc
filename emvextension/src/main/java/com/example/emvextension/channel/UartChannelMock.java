...
import static com.example.emvextension.channel.UartChannel.READ_DATA;
...
public class UartChannelMock extends Channel{
    ...
    public void write(byte[] payload) {
        ...
        if (success == 1){
            ...
            notifyAllListeners(READ_DATA, null,   new byte[] {25, -85, 30, 112, -66, -25, 127, 91, 5, -92, -81, -76, 1, 114, 44, -71, '1', '0', '.', '0', '0'});
        }
